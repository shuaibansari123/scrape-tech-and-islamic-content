...
from ImfeelingApp.models import MuhammadChildren  # Import the new model

class Command(BaseCommand):
    help = 'Scrape children of Prophet Muhammad (PBUH)'

    def handle(self, *args, **kwargs):
        # URL of the main page containing children sections
        main_url = "https://www.islamestic.com/children-of-prophet/"
        ...
        for section in sections:
            ...
            if content_div:
                ...
                # Create or update the MuhammadChildren entry
                child, created = MuhammadChildren.objects.update_or_create(
                    name=title,
                    defaults={'content': f"""
